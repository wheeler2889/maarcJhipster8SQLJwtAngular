...
import us.state.mn.dhs.IntegrationTest;
import us.state.mn.dhs.config.Constants;
import us.state.mn.dhs.domain.User;
import us.state.mn.dhs.repository.AuthorityRepository;
...
import us.state.mn.dhs.service.dto.PasswordChangeDTO;
import us.state.mn.dhs.web.rest.vm.KeyAndPasswordVM;
import us.state.mn.dhs.web.rest.vm.ManagedUserVM;
